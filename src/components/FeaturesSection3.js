    ...
    <section className=' py-[30px] lg:py-[120px] '>
      <div className=' flex flex-col  lg:flex-row'>
        ...
        <div className=' max-w-[454px] mb-6 lg:mt-10' data-aos='fade-right' data-aos-offset='400'>
          <h3 className=' h3 mb-6'>Grow your profit and track your invesments</h3>
          <p className=' text-gray mb-8 max-w-[408px]'>
            Use advanced analytical tools. Clear TrandeingView charts let you track current and historical profit invesments.
          </p>
          <button type="" className=' btn px-8'>Learn more</button>
        </div>
        {/* image */}
