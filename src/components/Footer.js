    ...
    <footer className=' lg:pt-24 pt-0' data-aos='fade-up' data-aos-offset='400'>
          ...
          <div className=' flex flex-1 flex-col gap-16 lg:flex-row'>
            <div className=' text-center w-full lg:text-left'>
              ...
              <ul className=' space-y-4 text-gray'>
                <li>
                  <a className=' hover:text-blue transition' href="#">Home</a>
                </li>
                <li>
                  <a className=' hover:text-blue transition' href="#">Products</a>
                </li>
                <li>
                  <a className=' hover:text-blue transition' href="#">About</a>
                </li>
                <li>
                  <a className=' hover:text-blue transition' href="#">Features</a>
                </li>
                <li>
                  <a className=' hover:text-blue transition' href="#">Contact</a>
                </li>
              </ul>
            </div>
            ...
            <div className=' text-center w-full lg:text-left'>
              ...
              <ul className=' space-y-4 text-gray'>
                <li>
                  <a className=' hover:text-blue transition' href="#">Download Whitepapper</a>
                </li>
                <li>
                  <a className=' hover:text-blue transition' href="#">Smart Token</a>
                </li>
                <li>
                  <a className=' hover:text-blue transition' href="#">Blockhain Explore</a>
                </li>
                <li>
                  <a className=' hover:text-blue transition' href="#">Crypto API</a>
                </li>
                <li>
                  <a className=' hover:text-blue transition' href="#">Interest</a>
                </li>
              </ul>
            </div>
      ...
      <div className=' py-12'>
        <div className=' container mx-auto flex flex-col items-center gap-y-6 lg:flex-row lg:justify-between lg:gap-y-0'>
           {/* copy text */}
           <div>
            &copy; 2023 CRAPPO. All rights reserved.
           </div>
           {/* social icons */}
