  ...
  return (
    <section className=' section lg:pt-[320px] bg-gradient-to-b from-[#f8f9fb] to-[#fafbff] text-darkblue lg:-mt-[320px]'>
      <div className=' container mx-auto'>
          <h2 className=' section-title text-center mb-16' data-aos = 'fade-up' data-aos-offset='400'>Trade securly and market the high growth cryptocurrencies.</h2>
            ...
            {currency.map((item, index) =>{
              ...
              return(
                <div 
                  ...
                  className={`${name === itemName ? 'bg-violet text-white' : 'bg-white'} w-full rounded-2xl py-12 px-6 shadow-primary cursor-pointer transition duration-300`}
                  key={index}>
                  <div className=' flex flex-col items-center justify-center'>
                    ...
                    <button className={`${name === itemName ? ' text-white bg-blue hover:bg-blue-hover border-none pl-8 pr-6 gap-x-3': 'text-blue w-16 border-2 border-gray-300'} border-2 border-gray-300 rounded-full h-16 flex justify-center items-center`}>
